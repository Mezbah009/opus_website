            ...
            <form action="" method="GET">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{route(" sliders.index")}}'"
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        @foreach ($sliders as $section)
                        <tr>
                            <td>{{$section->id}}</td>
                            <td>
                                @if(!empty($section->image))
                                <img src="{{asset('uploads/slider/'.$section->image)}}" class="img-thumbnail"
                            ...
                            <td>
                                <a href="{{route('sliders.edit',$section->id)}}">
                                ...
                                <a href="#" onclick="destroySlider({{$section->id}})" class="text-danger w-4 h-4 mr-1">
