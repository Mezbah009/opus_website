                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('uploads/first_section/'.$first_sec->image) }}" class="img-thumbnail"
                                    alt="{{$first_sec->title}}" width="50">
                                @else
                            ...
                            <td>
                                ...
                                <img src="{{ asset('uploads/first_section/'.$first_sec->logo) }}" class="img-thumbnail"
                                    alt="{{$first_sec->title}}" width="50">
                                @else
                                <img src="{{asset('admin-assets/img/default.png')}}" class="img-thumbnail"
                                    alt="default image" width="50">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('uploads/first_section/'.$third_sec->icon) }}" class="img-thumbnail"
                                    alt="" width="50">
                                @else
                                <img src="{{asset('admin-assets/img/default.png')}}" class="img-thumbnail"
                                    alt="default image" width="50">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('product_second_section.edit', $fourth_sec->id)}}">
                                    <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path
                                            d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z">
